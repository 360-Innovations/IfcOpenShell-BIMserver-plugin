...
import blueprints.interfaces.ifcconverter.EntityNotFoundException;
import blueprints.interfaces.ifcconverter.RenderEngineFilter;
...
import blueprints.interfaces.ifcconverter.RenderEngineSettings;
...
public class IfcOpenShellModel implements RenderEngineModel {
	...
	private HashMap<Integer,RenderEngineInstance> instancesById;
	...
	public void generateGeneralGeometry() throws RenderEngineException {
		...
		instancesById = new HashMap<Integer,RenderEngineInstance>();
